...
<body>
	...
	<!--section start-->
	<section class="section banner home h_ban">
		<div class="container">
			<div class="row rev_order">
				<div class="col-md-8">
					<h1 class="green_txt">The First and Only Comprehensive Advanced  Artificial Intelligence Learning Management System</h1>
					<div class="play_icon hm">
						<a target="_blank" href="https://youtu.be/kSicXXdsU5Q"><img src="images/play-oil.png" alt="The First and Only Comprehensive Advanced  Artificial Intelligence Learning Management System" title="The First and Only Comprehensive Advanced  Artificial Intelligence Learning Management System"></a>
					</div>
					<h2 class="white-text">Digital Education <span>|</span> Digital Learning Material <span>|</span> Digital Assessment <span>|</span> Digital Lab</h2> </div>
				<div class="col-md-4">
					<div class="box_sec">
						<h3>Our AI Programs:</h3>
						<ul class="bul_list">
							<li>Advanced Artificial Intelligence </li>
							<li>Advanced Data Engineering </li>
							<li>Advanced Computing</li>
							<li>After School AI Program </li>
						</ul>
						<div class="action_b"><a href="#" class="s-link">Read More <span class="arrow">&gt;</span></a></div>
					</div>
					<div class="box_sec green">
						<h3>Our Recognition:</h3>
						<ul class="bul_list">
							<li>US Senators</li>
							<li>US Treasure and US Mayor </li>
							<li>Canadian Members of Parliament</li>
						</ul>
						<div class="action_b"><a href="https://www.deepsphere.ai/accomplishments" class="s-link" target="_blank">Read More <span class="arrow">&gt;</span></a></div>
					</div>
					<div class="box_sec pink">
						<h3>Our Team:</h3>
						<ul class="bul_list">
							<li>MIT Learning Facilitator</li>
							<li>University of California Instructor </li>
							<li>Harvard PhDs and Stanford Alumni</li>
							</li>
						</ul>
						<div class="action_b"><a href="#Our_Team" class="s-link">Read More <span class="arrow">&gt;</span></a></div>
					</div>
	...
	<div class="white-diagonal-section-wrapper">
		...
		<div class="white-diagonal-section-container">
			<div class="container">
				<h2 align="center" class="b-line-green">Program Overview</h2>
				<br>
				...
				<div class="container scholl-grade-View">
					<div class="popover__wrapper_box">
						<a href="javascript:void();">
							<h2 class="popover__title"><img src="images/certificate/girl.jpg" alt="Student" title="Student"> </h2>
							<div class="overlay"></div>
						</a>
						<div class="popover__content contpop_1"> <img src="images/certificate/certificate.jpg"> </div>
					</div>
					<div class="popover__wrapper_box">
						<a href="javascript:void();">
							<h2 class="popover__title"><img src="images/certificate/girl.jpg" alt="Student" title="Student"></h2>
						...
						<div class="popover__content contpop_2"> <img src="images/certificate/certificate.jpg"> </div>
					</div>
					<div class="popover__wrapper_box">
						<a href="javascript:void();">
							<h2 class="popover__title"><img src="images/certificate/girl.jpg" alt="Student" title="Student"></h2>
						...
						<div class="popover__content contpop_3"> <img src="images/certificate/certificate.jpg"> </div>
					</div>
					<div class="popover__wrapper_box">
						<a href="javascript:void();">
							<h2 class="popover__title"><img src="images/certificate/girl.jpg" alt="Student" title="Student"></h2>
						...
						<div class="popover__content contpop_4"> <img src="images/certificate/certificate.jpg"> </div>
					</div>
					<div class="popover__wrapper_box">
						<a href="javascript:void();">
							<h2 class="popover__title"><img src="images/certificate/girl.jpg" alt="Student" title="Student"></h2>
						...
						<div class="popover__content contpop_5"> <img src="images/certificate/certificate.jpg"> </div>
					</div>
					<div class="popover__wrapper_box">
						<a href="javascript:void();">
							<h2 class="popover__title"><img src="images/certificate/girl.jpg" alt="Student" title="Student"></h2>
				...
				<div class="container">
					<div class="row learners m-auto">
						<ul class="client-Logo">
							<li class="ClientLog">
								<div class="image"> <img src="images/certificate/client-logo.jpg" alt="Reynald Lepine" title="Reynald Lepine"> </div>
							</li>
							<li class="ClientLog">
								<div class="image"> <img src="images/certificate/client-logo.jpg" alt="Reynald Lepine" title="Reynald Lepine"> </div>
							</li>
